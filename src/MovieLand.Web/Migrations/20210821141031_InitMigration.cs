    ...
    public partial class InitMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieCompare", x => new { x.MovieId, x.CompareId });
                    table.ForeignKey(
                        name: "FK_MovieCompare_Compare_CompareId",
                        column: x => x.CompareId,
                        principalTable: "Compare",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieCompare_Movie_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movie",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieFavorite", x => new { x.MovieId, x.FavoriteId });
                    table.ForeignKey(
                        name: "FK_MovieFavorite_Favorite_FavoriteId",
                        column: x => x.FavoriteId,
                        principalTable: "Favorite",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieFavorite_Movie_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movie",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieList", x => new { x.MovieId, x.ListId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieCompare_CompareId",
                table: "MovieCompare",
                column: "CompareId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieFavorite_FavoriteId",
                table: "MovieFavorite",
                column: "FavoriteId");
